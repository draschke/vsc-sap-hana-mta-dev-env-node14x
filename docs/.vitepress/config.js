...
let title =
  "VS Code Dev Container for SAP HANA App development for Node.js 14x";
let description =
  "VS Code Dev Container for SAP HANA App development (XSA and CF) for Node.js 14x";
let color = "#f42525";
...
module.exports = {
  ...
  head: [
    ...
    [
      "meta",
      { prefix: ogprefix, property: "og:locale:alternate", content: "en_GB" },
    ],
    ...
    [
      "meta",
      {
        ...
        property: "og:image",
        content:
          "https://draschke.github.io/vsc-sap-hana-mta-dev-env-node14x/hiddensee_1200_627.jpg",
      },
    ],
    ...
    [
      "meta",
      {
        ...
        property: "og:image",
        content:
          "https://draschke.github.io/vsc-sap-hana-mta-dev-env-node14x/hiddensee_600_314.jpg",
      },
    ],
    ...
    [
      "meta",
      {
        name: "keywords",
        content:
          "VS Container SAP Node.js 14.x, VS Dev Container SAP Node.js, VS Container SAP HANA Node.js, XSA, Fiori, Docker, SAPUI5, Kubernetes, K8s, Kyma, BTP, CF",
      },
    ],
